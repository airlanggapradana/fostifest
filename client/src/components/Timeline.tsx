...
const timelineData: TimelineItem[] = [
  {
    ...
    details: [
      ...
      '15 November: Batas pengumpulan karya UI/UX dan Software Development',
    ]
  },
  {
    id: '2',
    ...
    status: getTimelineStatus(...parseDateRange('16 - 17 November 2025'), now),
  ...
  },
  {
    ...
    status: getTimelineStatus(...parseDateRange('18 November 2025'), now),
