...
const LoginPage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title="Login | FOSTIFEST 2025 – FOSTI UMS"
        description="Masuk ke akun Anda untuk mengikuti FOSTIFEST 2025: lomba Competitive Programming, Software Development, UI/UX, dan workshop Vue.js."
        schema={{
          "@context": "https://schema.org",
          "@type": "WebPage",
          "name": "Login - FOSTIFEST 2025",
          "url": VITE_BASE_URL + "/login",
          "description": "Halaman login untuk FOSTIFEST 2025 oleh FOSTI UMS.",
          "image": home
        }}
      />
